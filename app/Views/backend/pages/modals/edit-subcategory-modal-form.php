<div class="modal fade" id="edit-subcategory-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered">
        <form action="<?= route_to('update-subcategory') ?>" method="POST" class="modal-content" id="update_subcategory_form">
